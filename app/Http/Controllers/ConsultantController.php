...
class ConsultantController extends Controller
{
    ...
    public function index($id, consultant $company){

    	//$jobs = Job::where('user_id',$id)->get();
    	return view('consultant.index',compact('company'));
    }
    ...
    public function create(){
        ...
        return view('consultant.create',compact('user', 'company', 'countries','coun_id','s_id','c_id','authority_designation','industry'));
    ...
    public function store(Request $request){
        ...
        consultant::where('user_id',$user_id)->update([
            'phone'=>request('phone'),
