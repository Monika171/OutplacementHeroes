...
class SemployerController extends Controller
{
    ...
    public function index($id, semployers $company){

    	//$jobs = Job::where('user_id',$id)->get();
    	return view('secompany.index',compact('company'));
    }
   ...
   public function create(){
     //  echo "Pavan";
      //  return view('/');
        ...
        $company = semployers::where('user_id', $user->id)->first();
       ...
       // return view('/');
        ...
        return view('secompany.create',compact('user','company' ,'countries','coun_id','s_id','c_id','authority_designation','industry'));
    ...
    public function store(Request $request){
        ...
        semployers::where('user_id',$user_id)->update([
            'phone'=>request('phone'),
        ...
        public function delete_ecover(Request $request){
            $id = request('id');
            $c = semployers::findOrFail($id);
            $filename = $c->cover_photo;
          
            //dd($filename);
          
            semployers::where('id',$id)->update([
              'cover_photo'=>null
            ]);
