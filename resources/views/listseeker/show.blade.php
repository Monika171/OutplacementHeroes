  ...
  <div class="container">
    ...
    <section class="ftco-section ftco-degree-bg">
      <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 sidebar ftco-animate">
                    ...
                    <div class="blog-entry align-self-stretch">
                        ...
                        <h3 class="heading">{{$user->profile->city}},&nbsp; &nbsp;{{$user->profile->state}}</h3>
        ...
        <h5 class="mb-2 mt-2">Current/Previous Company:</h5>
        <p>{{$user->profile->recent_company}}</p>

        <h5 class="mb-2 mt-2">Current/Previous Designation:</h5>
        ...
        <h5 class="mb-2 mt-2">Current Industry:</h5>
        <p>{{$user->profile->industry}}</p>

        <h5 class="mb-2 mt-2">Current CTC:</h5>
