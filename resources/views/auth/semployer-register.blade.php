...
{{--<div class="hero-wrap" style="height: 0px; background: linear-gradient(to bottom, #003399 0%, #666699 100%)" data-stellar-background-ratio="0.5">
    ...
    <div class="ftco-section bg-light">
      <div class="container">
        ...
        <div class="text-center"><h1 class="text">Separating Employer Signup</h1></div>
        </div>

          <div class="col-md-9 col-lg-8 mb-5 center" style="color: black; font-size: 14px;">
          
            <form method="POST" action="{{ route('semp.register') }}" class="p-5 bg-white">
                @csrf

                <input type="hidden" value="semployer" name="user_type">
