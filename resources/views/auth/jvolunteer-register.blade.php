...
@section('content')
      ...
      <div class="container">
            <div class="row no-gutters slider-text align-items-end justify-content-start" style="height: 410px" data-scrollax-parent="true">
                <div class="col-md-8 ftco-animate text-center text-md-left mb-5" data-scrollax=" properties: { translateY: '70%' }">
                    ...
                    <h1  style="font-size: 45px;" class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Job-Search Support Volunteer </h1>
                </div>
            </div>
      </div>
    </div>
    ...
    <div class="ftco-section bg-light">
      ...
      <div class="row form-group">
        <div class="col-md-12">
          <input type="submit" value="Register as Job-Search Support Volunteer" class="btn btn-primary  py-2 px-5">
        </div>
      </div>
